"use strict";
(self["webpackChunk_wcAdmin_webpackJsonp"] = self["webpackChunk_wcAdmin_webpackJsonp"] || []).push([[6637],{
...
__webpack_require__.d(__webpack_exports__, {
  "Z": function() { return /* binding */ report_table; }
});
...
var external_wp_dom_ = __webpack_require__(45904);
...
var external_wc_csvExport_ = __webpack_require__(49742);
...
/* harmony default export */ var download_icon = (() => (0,external_wp_element_.createElement)("svg", {
  role: "img",
  "aria-hidden": "true",
  focusable: "false",
  version: "1.1",
...
function extendTableData(extendedStoreSelector, props, queriedTableData) {
  ...
  const extendedItemsData = itemsData.map(item => {
    const extendedItemData = (0,external_lodash_.first)(extendedItems.filter(extendedItem => item.id === extendedItem.id));
    return { ...item,
      ...extendedItemData
    };
  });
...
const ReportTable = props => {
  ...
  const initialSelectedRows = query[compareParam] ? (0,external_wc_navigation_.getIdsFromQuery)(query[compareBy]) : [];
  const [selectedRows, setSelectedRows] = (0,external_wp_element_.useState)(initialSelectedRows);
  const scrollPointRef = (0,external_wp_element_.useRef)(null);
  const {
    updateUserPreferences,
    ...userData
  } = (0,external_wc_data_.useUserPreferences)(); // Bail early if we've encountered an error.
  ...
  const onPageChange = (newPage, source) => {
    ...
    if (source) {
      if (source === 'goto') {
        (0,external_wc_tracks_.recordEvent)('analytics_table_go_to_page', {
          report: endpoint,
          page: newPage
        });
      } else {
        (0,external_wc_tracks_.recordEvent)('analytics_table_page_click', {
          report: endpoint,
          direction: source
        });
      }
  ...
  const trackTableSearch = () => {
    ...
    (0,external_wc_tracks_.recordEvent)('analytics_table_filter', {
      report: endpoint
    });
  };

  const onSort = (key, direction) => {
    (0,external_wc_navigation_.onQueryChange)('sort')(key, direction);
    const eventProps = {
      report: endpoint,
      column: key,
      direction
    };
    (0,external_wc_tracks_.recordEvent)('analytics_table_sort', eventProps);
  };
  ...
  const applyTableFilters = (data, totals, totalResults) => {
    ...
    return (0,external_wp_hooks_.applyFilters)(TABLE_FILTER, {
      endpoint,
  ...
  const onClickDownload = () => {
    ...
    if (data && data.length === totalResults) {
      ...
      (0,external_wc_csvExport_.downloadCSVFile)((0,external_wc_csvExport_.generateCSVFileName)(title, params), (0,external_wc_csvExport_.generateCSVDataFromTable)(headers, rows));
    } else {
      downloadType = 'email';
      startExport(endpoint, reportQuery).then(() => createNotice('success', (0,external_wp_i18n_.sprintf)(
      /* translators: %s = type of report */
      (0,external_wp_i18n_.__)('Your %s Report will be emailed to you.', 'woocommerce'), title))).catch(error => createNotice('error', error.message || (0,external_wp_i18n_.sprintf)(
      /* translators: %s = type of report */
      (0,external_wp_i18n_.__)('There was a problem exporting your %s Report. Please try again.', 'woocommerce'), title)));
    }

    (0,external_wc_tracks_.recordEvent)('analytics_table_download', {
      report: endpoint,
      rows: totalResults,
  ...
  const onCompare = () => {
    if (compareBy) {
      (0,external_wc_navigation_.onQueryChange)('compare')(compareBy, compareParam, selectedRows.join(','));
    }
  };
  ...
  const onSearchChange = values => {
    ...
    if (searchTerms.length) {
      (0,external_wc_navigation_.updateQueryString)({
        ...
        [searchBy]: undefined,
        ...baseSearchQuery,
        search: (0,external_lodash_.uniq)(searchTerms).join(',')
  ...
  const selectRow = (i, checked) => {
    ...
    if (checked) {
      setSelectedRows((0,external_lodash_.uniq)([ids[i], ...selectedRows]));
    } else {
  ...
  const getCheckbox = i => {
    ...
    return {
      display: (0,external_wp_element_.createElement)(external_wp_components_.CheckboxControl, {
        onChange: (0,external_lodash_.partial)(selectRow, i),
        checked: isChecked
      }),
      value: false
    };
  ...
  const getAllCheckbox = () => {
    ...
    return {
      ...
      key: 'compare',
      label: (0,external_wp_element_.createElement)(external_wp_components_.CheckboxControl, {
        onChange: selectAllRows,
        "aria-label": (0,external_wp_i18n_.__)('Select All'),
  ...
  const totals = (0,external_lodash_.get)(primaryData, ['data', 'totals'], {});
  ...
  const searchWords = (0,external_wc_navigation_.getSearchWords)(query);
  ...
  const onColumnsChange = (shownColumns, toggledColumn) => {
    ...
    if (toggledColumn) {
      ...
      (0,external_wc_tracks_.recordEvent)('analytics_table_header_toggle', eventProps);
    }
  ...
  return (0,external_wp_element_.createElement)(external_wp_element_.Fragment, null, (0,external_wp_element_.createElement)("div", {
    ...
    ref: scrollPointRef,
    "aria-hidden": true
  }), (0,external_wp_element_.createElement)(external_wc_components_.TableCard, (0,esm_extends/* default */.Z)({
    className: 'woocommerce-report-table',
    hasSearch: !!searchBy,
    actions: [compareBy && (0,external_wp_element_.createElement)(external_wc_components_.CompareButton, {
      key: "compare",
      className: "woocommerce-table__compare",
      count: selectedRows.length,
      helpText: labels.helpText || (0,external_wp_i18n_.__)('Check at least two items below to compare', 'woocommerce'),
      onClick: onCompare,
      disabled: !downloadable
    }, labels.compareButton || (0,external_wp_i18n_.__)('Compare', 'woocommerce')), searchBy && (0,external_wp_element_.createElement)(external_wc_components_.Search, {
      allowFreeTextSearch: true,
      inlineTags: true,
      key: "search",
      onChange: onSearchChange,
      placeholder: labels.placeholder || (0,external_wp_i18n_.__)('Search by item name', 'woocommerce'),
      selected: searchedLabels,
      showClearButton: true,
      type: searchBy,
      disabled: !downloadable
    }), downloadable && (0,external_wp_element_.createElement)(external_wp_components_.Button, {
      key: "download",
      className: "woocommerce-table__download-button",
      disabled: isLoading,
      onClick: onClickDownload
    }, (0,external_wp_element_.createElement)(download_icon, null), (0,external_wp_element_.createElement)("span", {
      className: "woocommerce-table__download-button__label"
    }, labels.downloadButton || (0,external_wp_i18n_.__)('Download', 'woocommerce')))],
...
ReportTable.propTypes = {
   ...
   */
  extendItemsMethodNames: prop_types_default().shape({
    getError: (prop_types_default()).string,
    isRequesting: (prop_types_default()).string,
    load: (prop_types_default()).string
  }),

  /**
   * Name of store on which extendItemsMethodNames can be found.
   */
  extendedItemsStoreName: (prop_types_default()).string,
...
const EMPTY_ARRAY = [];
const EMPTY_OBJECT = {};
/* harmony default export */ var report_table = ((0,external_wp_compose_.compose)((0,external_wp_data_.withSelect)((select, props) => {
  const {
    endpoint,
    getSummary,
    isRequesting,
  ...
  const primaryData = getSummary ? (0,external_wc_data_.getReportChartData)({
  ...
  const queriedTableData = tableData || (0,external_wc_data_.getReportTableData)({
    endpoint,
    query,
    selector: reportStoreSelector,
    tableQuery,
  ...
  const {
    addCesSurveyForCustomerSearch
  } = dispatch(constants/* STORE_KEY */.Ls);
  return {
    createNotice,
    startExport,
    addCesSurveyForCustomerSearch
