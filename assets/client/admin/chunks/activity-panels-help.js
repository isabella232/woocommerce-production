"use strict";
(self["webpackChunk_wcAdmin_webpackJsonp"] = self["webpackChunk_wcAdmin_webpackJsonp"] || []).push([[6732],{
...
__webpack_require__.d(__webpack_exports__, {
  "HelpPanel": function() { return /* binding */ HelpPanel; },
  "SETUP_TASK_HELP_ITEMS_FILTER": function() { return /* binding */ SETUP_TASK_HELP_ITEMS_FILTER; },
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/@wordpress+icons@8.1.0/node_modules/@wordpress/icons/build-module/library/page.js
var page = __webpack_require__(33040);
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/redux@4.1.2/node_modules/redux/es/redux.js
...
function getAppearanceItems() {
  return [{
    title: (0,external_wp_i18n_.__)('Showcase your products and tailor your shopping experience using Blocks', 'woocommerce'),
    link: 'https://woocommerce.com/document/woocommerce-blocks/?utm_source=help_panel&utm_medium=product'
  }, {
    title: (0,external_wp_i18n_.__)('Manage Store Notice, Catalog View and Product Images', 'woocommerce'),
    link: 'https://woocommerce.com/document/woocommerce-customizer/?utm_source=help_panel&utm_medium=product'
  }, {
    title: (0,external_wp_i18n_.__)('How to choose and change a theme', 'woocommerce'),
...
function getMarketingItems(props) {
  ...
  return [activePlugins.includes('mailpoet') && {
    title: (0,external_wp_i18n_.__)('Get started with Mailpoet', 'woocommerce'),
    link: 'https://kb.mailpoet.com/category/114-getting-started'
  }, activePlugins.includes('google-listings-and-ads') && {
    title: (0,external_wp_i18n_.__)('Set up Google Listing & Ads', 'woocommerce'),
    ...
    title: (0,external_wp_i18n_.__)('Set up Pinterest for WooCommerce', 'woocommerce'),
    link: 'https://woocommerce.com/products/pinterest-for-woocommerce/'
  }, activePlugins.includes('mailchimp-for-woocommerce') && {
    title: (0,external_wp_i18n_.__)('Connect Mailchimp for WooCommerce', 'woocommerce'),
    ...
    title: (0,external_wp_i18n_.__)('Set up Creative Mail for WooCommerce', 'woocommerce'),
...
function getPaymentGatewaySuggestions(props) {
  ...
  return [{
    title: (0,external_wp_i18n_.__)('Which Payment Option is Right for Me?', 'woocommerce'),
    ...
    title: (0,external_wp_i18n_.__)('WooCommerce Payments Start Up Guide', 'woocommerce'),
    link: 'https://woocommerce.com/document/payments/?utm_source=help_panel&utm_medium=product'
  }, paymentGatewaySuggestions.woocommerce_payments && {
    title: (0,external_wp_i18n_.__)('WooCommerce Payments FAQs', 'woocommerce'),
    ...
    title: (0,external_wp_i18n_.__)('Stripe Setup and Configuration', 'woocommerce'),
    ...
    title: (0,external_wp_i18n_.__)('PayPal Checkout Setup and Configuration', 'woocommerce'),
    ...
    title: (0,external_wp_i18n_.__)('Square - Get started', 'woocommerce'),
    ...
    title: (0,external_wp_i18n_.__)('Klarna - Introduction', 'woocommerce'),
    ...
    title: (0,external_wp_i18n_.__)('PayFast Setup and Configuration', 'woocommerce'),
    ...
    title: (0,external_wp_i18n_.__)('Eway Setup and Configuration', 'woocommerce'),
    link: 'https://woocommerce.com/document/eway/?utm_source=help_panel&utm_medium=product'
  }, {
    title: (0,external_wp_i18n_.__)('Direct Bank Transfer (BACS)', 'woocommerce'),
    link: 'https://woocommerce.com/document/bacs/?utm_source=help_panel&utm_medium=product'
  }, {
    title: (0,external_wp_i18n_.__)('Cash on Delivery', 'woocommerce'),
...
function getProductsItems() {
  return [{
    title: (0,external_wp_i18n_.__)('Adding and Managing Products', 'woocommerce'),
    link: 'https://woocommerce.com/document/managing-products/?utm_source=help_panel&utm_medium=product'
  }, {
    title: (0,external_wp_i18n_.__)('Import products using the CSV Importer and Exporter', 'woocommerce'),
    link: 'https://woocommerce.com/document/product-csv-importer-exporter/?utm_source=help_panel&utm_medium=product'
  }, {
    title: (0,external_wp_i18n_.__)('Migrate products using Cart2Cart', 'woocommerce'),
    link: 'https://woocommerce.com/products/cart2cart/?utm_source=help_panel&utm_medium=product'
  }, {
    title: (0,external_wp_i18n_.__)('Learn more about setting up products', 'woocommerce'),
...
function getShippingItems(_ref) {
  ...
  return [{
    title: (0,external_wp_i18n_.__)('Setting up Shipping Zones', 'woocommerce'),
    link: 'https://woocommerce.com/document/setting-up-shipping-zones/?utm_source=help_panel&utm_medium=product'
  }, {
    title: (0,external_wp_i18n_.__)('Core Shipping Options', 'woocommerce'),
    ...
    title: (0,external_wp_i18n_.__)('Product Shipping Classes', 'woocommerce'),
    link: 'https://woocommerce.com/document/product-shipping-classes/?utm_source=help_panel&utm_medium=product'
  }, showWCS && {
    title: (0,external_wp_i18n_.__)('WooCommerce Shipping setup and configuration', 'woocommerce'),
    link: 'https://woocommerce.com/document/woocommerce-shipping-and-tax/?utm_source=help_panel&utm_medium=product#section-3'
  }, {
    title: (0,external_wp_i18n_.__)('Learn more about configuring your shipping settings', 'woocommerce'),
...
function getTaxItems(props) {
  ...
  return [{
    title: (0,external_wp_i18n_.__)('Setting up Taxes in WooCommerce', 'woocommerce'),
    link: 'https://woocommerce.com/document/setting-up-taxes-in-woocommerce/?utm_source=help_panel&utm_medium=product'
  }, showWCS && {
    title: (0,external_wp_i18n_.__)('Automated Tax calculation using WooCommerce Tax', 'woocommerce'),
...
function getListItems(props) {
  ...
  const genericDocsLink = {
    title: (0,external_wp_i18n_.__)('WooCommerce Docs', 'woocommerce'),
  ...
  const filteredItems = (0,external_wp_hooks_.applyFilters)(SETUP_TASK_HELP_ITEMS_FILTER, itemsByType, props.taskName, props); // Filter out items that aren't objects without `title` and `link` properties.
  ...
  const onClick = (0,external_lodash_.partial)(handleOnItemClick, props);
  return validatedItems.map(item => ({
    ...
    before: (0,external_wp_element_.createElement)(icon/* default */.Z, {
      icon: page/* default */.Z
    }),
    after: (0,external_wp_element_.createElement)(icon/* default */.Z, {
...
const HelpPanel = props => {
  ...
  return (0,external_wp_element_.createElement)(external_wp_element_.Fragment, null, (0,external_wp_element_.createElement)(activity_header/* default */.Z, {
    title: (0,external_wp_i18n_.__)('Documentation', 'woocommerce')
  }), (0,external_wp_element_.createElement)(external_wc_components_.Section, null, (0,external_wp_element_.createElement)(external_wc_components_.List, {
    items: listItems,
...
/* harmony default export */ var help = (compose((0,external_wp_data_.withSelect)(select => {
  const {
    getSettings
  ...
  const countryCode = (0,utils/* getCountryCode */.so)(generalSettings.woocommerce_default_country);
  return {
    activePlugins,
    countryCode,
    paymentGatewaySuggestions,
