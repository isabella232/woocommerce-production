(self["webpackChunk_wcAdmin_webpackJsonp"] = self["webpackChunk_wcAdmin_webpackJsonp"] || []).push([[1996],{
...
/* harmony default export */ var components_button = (props => {
  return (0,external_wp_element_.createElement)(external_wp_components_.Button, (0,esm_extends/* default */.Z)({}, props, {
...
const Card = props => {
  ...
  return (0,external_wp_element_.createElement)(external_wp_components_.Card, {
  ...
  }, (0,external_wp_element_.createElement)(external_wp_components_.CardHeader, null, (0,external_wp_element_.createElement)("div", null, (0,external_wp_element_.createElement)(external_wc_experimental_.Text, {
    variant: "title.small",
    as: "p",
    size: "20",
    lineHeight: "28px"
    ...
    size: "14",
    lineHeight: "20px"
  }, description))), (0,external_wp_element_.createElement)(external_wp_components_.CardBody, null, children));
};
...
const blank = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  width: "36",
  height: "36",
  fill: "none",
...
const amazonEbay = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  xmlns: "http://www.w3.org/2000/svg",
  width: "100",
  height: "100",
  viewBox: "0 0 100 100"
...
const automatewoo = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  xmlns: "http://www.w3.org/2000/svg",
  width: "100",
  height: "100",
  viewBox: "0 0 100 100"
...
const automatewooAlt = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  xmlns: "http://www.w3.org/2000/svg"
}, (0,external_wp_element_.createElement)(external_wp_primitives_.Path, {
  fillRule: "evenodd",
  clipRule: "evenodd",
...
const facebook = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  width: "36",
  height: "36",
  viewBox: "0 0 36 36",
  fill: "none",
...
const pinterest = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  width: "303",
  height: "303",
...
const google = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  xmlns: "http://www.w3.org/2000/svg",
  width: "128",
  height: "128",
  viewBox: "0 0 128 128"
...
const hubspot = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  xmlns: "http://www.w3.org/2000/svg",
  width: "100",
  height: "100",
  viewBox: "0 0 100 100"
...
const mailchimp = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  width: "36",
  height: "36",
  viewBox: "0 0 36 36",
  fill: "none",
...
const mailpoet = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  xmlns: "http://www.w3.org/2000/svg",
...
const currencyDollar = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, (0,external_wp_element_.createElement)(external_wp_primitives_.Path, {
...
const gift = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  xmlns: "http://www.w3.org/2000/svg"
}, (0,external_wp_element_.createElement)(external_wp_primitives_.Path, {
  fillRule: "evenodd",
  clipRule: "evenodd",
...
const link_link = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, (0,external_wp_element_.createElement)(external_wp_primitives_.Path, {
...
const people = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, (0,external_wp_element_.createElement)(external_wp_primitives_.Path, {
...
const tip = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  xmlns: "http://www.w3.org/2000/svg"
}, (0,external_wp_element_.createElement)(external_wp_primitives_.Path, {
  fillRule: "evenodd",
  clipRule: "evenodd",
...
class ProductIcon extends external_wp_element_.Component {
  render() {
    const product = (0,external_lodash_.camelCase)(this.props.product);
...
const Slider = _ref => {
  ...
  const [height, updateHeight] = (0,external_wp_element_.useState)(null);
  const container = (0,external_wp_element_.useRef)();
  ...
  const debouncedUpdateSliderHeight = (0,external_lodash_.debounce)(updateSliderHeight, 50);
  ...
  return (0,external_wp_element_.createElement)("div", {
    ...
    ref: container,
    style: style
  }, (0,external_wp_element_.createElement)(TransitionGroup/* default */.Z, null, (0,external_wp_element_.createElement)(CSSTransition/* default */.Z, {
    timeout: timeout,
    classNames: "slide",
    key: animationKey,
    onEnter: onEnter
...
class InstalledExtensionRow extends external_wp_element_.Component {
  constructor(props) {
    super(props);
  ...
  getLinks() {
    ...
    if (docsUrl) {
      links.push({
        key: 'docs',
        href: docsUrl,
        text: (0,external_wp_i18n_.__)('Docs', 'woocommerce')
      });
    }
    ...
    if (supportUrl) {
      links.push({
        key: 'support',
        href: supportUrl,
        text: (0,external_wp_i18n_.__)('Get support', 'woocommerce')
      });
    }
    ...
    if (settingsUrl) {
      links.push({
        key: 'settings',
        href: settingsUrl,
        text: (0,external_wp_i18n_.__)('Settings', 'woocommerce')
      });
    }
    ...
    if (dashboardUrl) {
      links.push({
        key: 'dashboard',
        href: dashboardUrl,
        text: (0,external_wp_i18n_.__)('Dashboard', 'woocommerce')
      });
    }
    ...
    return (0,external_wp_element_.createElement)("ul", {
      ...
      return (0,external_wp_element_.createElement)("li", {
        key: link.key
  ...
  onLinkClick(link) {
    ...
    (0,external_wc_tracks_.recordEvent)('marketing_installed_options', {
      name,
      link: link.key
    });
  }
  ...
  onActivateClick() {
    ...
    (0,external_wc_tracks_.recordEvent)('marketing_installed_activate', {
      name
    });
    activatePlugin();
  }
  ...
  onFinishSetupClick() {
    ...
    (0,external_wc_tracks_.recordEvent)('marketing_installed_finish_setup', {
      name
    });
  }
  ...
  getActivateButton() {
    ...
    return (0,external_wp_element_.createElement)(components_button, {
      isSecondary: true,
      onClick: this.onActivateClick,
      disabled: isLoading
    }, (0,external_wp_i18n_.__)('Activate', 'woocommerce'));
  }
  ...
  getFinishSetupButton() {
    ...
    }, (0,external_wp_i18n_.__)('Finish setup', 'woocommerce'));
  }
  ...
  render() {
    ...
    }, (0,external_wp_element_.createElement)(product_icon, {
      product: slug
    }), (0,external_wp_element_.createElement)("div", {
    ...
    }, (0,external_wp_element_.createElement)("h4", null, name), status === 'configured' || (0,external_wp_element_.createElement)("p", {
...
InstalledExtensionRow.propTypes = {
  ...
  settingsUrl: (prop_types_default()).string,
  docsUrl: (prop_types_default()).string,
  supportUrl: (prop_types_default()).string,
  dashboardUrl: (prop_types_default()).string,
  activatePlugin: (prop_types_default()).func.isRequired
};
/* harmony default export */ var row = (InstalledExtensionRow);
...
class InstalledExtensions extends external_wp_element_.Component {
  ...
  render() {
    ...
    const title = (0,external_wp_i18n_.__)('Installed marketing extensions', 'woocommerce');
    ...
    return (0,external_wp_element_.createElement)(external_wp_components_.Card, {
      ...
      return (0,external_wp_element_.createElement)(row, (0,esm_extends/* default */.Z)({
        key: plugin.slug
      }, plugin, {
...
InstalledExtensions.propTypes = {
   ...
   */
  plugins: prop_types_default().arrayOf((prop_types_default()).object).isRequired,

  /**
   * Array of plugins that are currently activating.
   */
  activatingPlugins: prop_types_default().arrayOf((prop_types_default()).string).isRequired
};
/* harmony default export */ var installed_extensions = ((0,external_wp_compose_.compose)((0,external_wp_data_.withSelect)(select => {
  const {
    getInstalledPlugins,
...
var in_app_purchase = __webpack_require__(91287);
...
const RecommendedExtensionsItem = _ref => {
  ...
  const onProductClick = () => {
    (0,external_wc_tracks_.recordEvent)('marketing_recommended_extension', {
      name: title
    });
  };

  const classNameBase = 'woocommerce-marketing-recommended-extensions-item';
  const connectURL = (0,in_app_purchase/* getInAppPurchaseUrl */.C)(url); // Temporary fix to account for different styles between marketing & coupons
  ...
  }, (0,external_wp_element_.createElement)("h4", null, title), (0,external_wp_element_.createElement)("p", null, description)));
};
...
const RecommendedExtensionsPlaceholder = () => {
  ...
  return (0,external_wp_element_.createElement)("div", {
    ...
    className: `${classNameBase}__text`
  }, (0,external_wp_element_.createElement)("h4", {
    className: "is-placeholder",
    "aria-hidden": "true"
  }), (0,external_wp_element_.createElement)("p", null, (0,external_wp_element_.createElement)("span", {
    className: "is-placeholder"
...
const RecommendedExtensions = _ref => {
  ...
  return (0,external_wp_element_.createElement)(card, {
    title: title,
    description: description,
    className: classnames_default()('woocommerce-marketing-recommended-extensions-card', categoryClass)
  }, isLoading ? (0,external_wp_element_.createElement)("div", {
  ...
  }, [...Array(placholdersCount).keys()].map(key => (0,external_wp_element_.createElement)(placeholder, {
    key: key
  }))) : (0,external_wp_element_.createElement)("div", {
  ...
  }, extensions.map(extension => (0,external_wp_element_.createElement)(item, (0,esm_extends/* default */.Z)({
...
RecommendedExtensions.defaultProps = {
  title: (0,external_wp_i18n_.__)('Recommended extensions', 'woocommerce'),
  description: (0,external_wp_i18n_.__)('Great marketing requires the right tools. Take your marketing to the next level with our recommended marketing extensions.', 'woocommerce')
};


/* harmony default export */ var recommended_extensions = ((0,external_wp_compose_.compose)((0,external_wp_data_.withSelect)((select, props) => {
  const {
...
const ReadBlogMessage = () => {
  return (0,esm/* default */.Z)({
    mixedString: (0,external_wp_i18n_.__)('Read {{link}}the WooCommerce blog{{/link}} for more tips on marketing your store', 'woocommerce'),
    components: {
...
const KnowledgeBase = _ref => {
  ...
  const [page, updatePage] = (0,external_wp_element_.useState)(1);
  const [animate, updateAnimate] = (0,external_wp_element_.useState)(null);
  ...
  const onPaginationPageChange = newPage => {
    ...
    if (newPage > page) {
      newAnimate = 'left';
      (0,external_wc_tracks_.recordEvent)('marketing_knowledge_carousel', {
        direction: 'forward',
        page: newPage
      });
    } else {
  ...
  const onPostClick = post => {
    (0,external_wc_tracks_.recordEvent)('marketing_knowledge_article', {
      title: post.title
    });
  };
  /**
  ...
  const getCurrentSlide = () => {
    ...
    const displayPosts = currentPosts.map((post, index) => {
      ...
      }, post.image && (0,external_wp_element_.createElement)("div", {
      ...
      }, (0,external_wp_element_.createElement)("h3", null, post.title), (0,external_wp_element_.createElement)("p", {
        className: "woocommerce-marketing-knowledgebase-card__post-meta"
      }, (0,external_wp_i18n_.__)('By', 'woocommerce') + ' ', post.author_name, post.author_avatar && (0,external_wp_element_.createElement)("img", {
  ...
  const renderEmpty = () => {
    const emptyTitle = (0,external_wp_i18n_.__)('No posts yet', 'woocommerce');

    return (0,external_wp_element_.createElement)(external_wc_components_.EmptyContent, {
      title: emptyTitle,
      message: (0,external_wp_element_.createElement)(knowledge_base_ReadBlogMessage, null),
      illustration: "",
      actionLabel: ""
    });
  };
  ...
  const renderError = () => {
    const errorTitle = (0,external_wp_i18n_.__)("Oops, our posts aren't loading right now", 'woocommerce');
  ...
  const renderPosts = () => {
    ...
    }, (0,external_wp_element_.createElement)(slider, {
      animationKey: page,
      animate: animate
    }, getCurrentSlide()), (0,external_wp_element_.createElement)(external_wc_components_.Pagination, {
      page: page,
      perPage: 2,
      total: posts.length,
  ...
  const renderPlaceholder = () => {
    ...
    }, (0,external_wp_element_.createElement)(knowledge_base_placeholder, null), (0,external_wp_element_.createElement)(knowledge_base_placeholder, null)));
  };
...
KnowledgeBase.defaultProps = {
  title: (0,external_wp_i18n_.__)('WooCommerce knowledge base', 'woocommerce'),
  description: (0,external_wp_i18n_.__)('Learn the ins and outs of successful marketing from the experts at WooCommerce.', 'woocommerce')
};

/* harmony default export */ var knowledge_base = ((0,external_wp_compose_.compose)((0,external_wp_data_.withSelect)((select, props) => {
  const {
    getBlogPosts,
    getBlogPostsError,
    isResolving
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/gridicons@3.4.0_react@17.0.2/node_modules/gridicons/dist/cross.js
var cross = __webpack_require__(46634);
// EXTERNAL MODULE: ./client/marketing/overview/welcome-card/images/welcome.svg
var welcome = __webpack_require__(43013);
...
const WelcomeCard = _ref => {
  ...
  const hide = () => {
    ...
    (0,external_wc_tracks_.recordEvent)('marketing_intro_close', {});
  };
  ...
  }, (0,external_wp_element_.createElement)(external_wp_components_.CardBody, null, (0,external_wp_element_.createElement)(external_wp_components_.Button, {
    label: (0,external_wp_i18n_.__)('Hide', 'woocommerce'),
    onClick: hide,
    className: "woocommerce-marketing-overview-welcome-card__hide-button"
  }, (0,external_wp_element_.createElement)(cross/* default */.Z, null)), (0,external_wp_element_.createElement)("img", {
    src: (welcome_default()),
    alt: ""
  }), (0,external_wp_element_.createElement)("h3", null, (0,external_wp_i18n_.__)('Grow your customer base and increase your sales with marketing tools built for WooCommerce', 'woocommerce'))));
};
...
WelcomeCard.propTypes = {
   ...
   */
  isHidden: (prop_types_default()).bool.isRequired,
...
/* harmony default export */ var welcome_card = ((0,external_wp_compose_.compose)((0,external_wp_data_.withSelect)(select => {
  const {
    getOption,
    isOptionsUpdating
...
function* activateInstalledPlugin(pluginSlug) {
  ...
  try {
    const response = yield (0,external_wp_dataControls_.apiFetch)({
    ...
    if (response) {
      yield createNotice('success', (0,external_wp_i18n_.__)('The extension has been successfully activated.', 'woocommerce')); // Deliberately load the new plugin data in a new request.
    ...
    yield handleFetchError(error, (0,external_wp_i18n_.__)('There was an error trying to activate the extension.', 'woocommerce'));
...
function* loadInstalledPluginsAfterActivation(activatedPluginSlug) {
  try {
    ...
    yield handleFetchError(error, (0,external_wp_i18n_.__)('There was an error loading installed extensions.', 'woocommerce'));
  }
}
...
function* resolvers_getRecommendedPlugins(category) {
  try {
    ...
    yield handleFetchError(error, (0,external_wp_i18n_.__)('There was an error loading recommended extensions.', 'woocommerce'));
  }
}
...
const {
  installedExtensions
} = (0,admin_settings/* getAdminSetting */.O3)('marketing', {});
const DEFAULT_STATE = {
...
const reducer = function () {
  ...
  switch (action.type) {
    ...
    case action_types.REMOVE_ACTIVATING_PLUGIN:
      return { ...state,
        activatingPlugins: (0,external_lodash_.without)(state.activatingPlugins, action.pluginSlug)
      };
...
(0,external_wp_data_.registerStore)(STORE_KEY, {
...
const MarketingOverview = () => {
  ...
  const shouldShowExtensions = (0,admin_settings/* getAdminSetting */.O3)('allowMarketplaceSuggestions', false) && currentUserCan('install_plugins');
  return (0,external_wp_element_.createElement)("div", {
    className: "woocommerce-marketing-overview"
  }, (0,external_wp_element_.createElement)(welcome_card, null), (0,external_wp_element_.createElement)(installed_extensions, null), shouldShowExtensions && (0,external_wp_element_.createElement)(recommended_extensions, {
    category: "marketing"
  }), (0,external_wp_element_.createElement)(knowledge_base, {
    category: "marketing"
  }));
};

/* harmony default export */ var overview = ((0,external_wc_data_.withOptionsHydration)({ ...(0,admin_settings/* getAdminSetting */.O3)('preloadOptions', {})
})(MarketingOverview));
