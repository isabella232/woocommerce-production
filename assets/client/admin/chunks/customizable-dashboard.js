"use strict";
(self["webpackChunk_wcAdmin_webpackJsonp"] = self["webpackChunk_wcAdmin_webpackJsonp"] || []).push([[8960],{
...
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(7862);
...
/* harmony import */ var _customer_effort_score_tracks_data_constants__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(79548);
/* harmony import */ var _utils_admin_settings__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(4411);
...
class ReportFilters extends _wordpress_element__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  onDateSelect(data) {
    ...
    addCesSurveyForAnalytics();
    (0,_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_7__.recordEvent)('datepicker_update', {
      report,
      ...(0,lodash__WEBPACK_IMPORTED_MODULE_2__.omitBy)(data, lodash__WEBPACK_IMPORTED_MODULE_2__.isUndefined)
    });
  }
  ...
  onFilterSelect(data) {
    ...
    (0,_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_7__.recordEvent)('analytics_filter', eventProperties);
  }
  ...
  onAdvancedFilterAction(action, data) {
    ...
    switch (action) {
      case 'add':
        (0,_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_7__.recordEvent)('analytics_filters_add', {
          report,
          filter: data.key
        });
        break;
      ...
      case 'remove':
        (0,_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_7__.recordEvent)('analytics_filters_remove', {
          report,
          filter: data.key
        });
        break;
      ...
      case 'filter':
        const snakeCaseData = Object.keys(data).reduce((result, property) => {
          result[(0,lodash__WEBPACK_IMPORTED_MODULE_2__.snakeCase)(property)] = data[property];
          return result;
        }, {});
        addCesSurveyForAnalytics();
        (0,_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_7__.recordEvent)('analytics_filters_filter', {
          report,
          ...snakeCaseData
        });
        break;
      ...
      case 'clear_all':
        (0,_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_7__.recordEvent)('analytics_filters_clear_all', {
          report
        });
        break;

      case 'match':
        (0,_woocommerce_tracks__WEBPACK_IMPORTED_MODULE_7__.recordEvent)('analytics_filters_all_any', {
          report,
          value: data.match
        });
        break;
  ...
  render() {
    ...
    } = (0,_woocommerce_date__WEBPACK_IMPORTED_MODULE_6__.getCurrentDates)(query, defaultDateRange);
    const dateQuery = {
      period,
      compare,
      before,
    ...
    return (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_0__.createElement)(_woocommerce_components__WEBPACK_IMPORTED_MODULE_4__.ReportFilters, {
      query: query,
      siteLocale: _utils_admin_settings__WEBPACK_IMPORTED_MODULE_9__/* .LOCALE.siteLocale */ .MV.siteLocale,
      ...
      dateQuery: dateQuery,
      isoDateFormat: _woocommerce_date__WEBPACK_IMPORTED_MODULE_6__.isoDateFormat
    });
  }

}

ReportFilters.contextType = _lib_currency_context__WEBPACK_IMPORTED_MODULE_8__/* .CurrencyContext */ .$;
/* harmony default export */ __webpack_exports__["Z"] = ((0,_wordpress_compose__WEBPACK_IMPORTED_MODULE_1__.compose)((0,_wordpress_data__WEBPACK_IMPORTED_MODULE_3__.withSelect)(select => {
  const {
    woocommerce_default_date_range: defaultDateRange
  } = select(_woocommerce_data__WEBPACK_IMPORTED_MODULE_5__.SETTINGS_STORE_NAME).getSetting('wc_admin', 'wcAdminSettings');
  return {
    defaultDateRange
  };
  ...
  const {
    addCesSurveyForAnalytics
  } = dispatch(_customer_effort_score_tracks_data_constants__WEBPACK_IMPORTED_MODULE_10__/* .STORE_KEY */ .Ls);
  return {
    addCesSurveyForAnalytics
  };
}))(ReportFilters));
ReportFilters.propTypes = {
   ...
   */
  advancedFilters: (prop_types__WEBPACK_IMPORTED_MODULE_11___default().object),

  /**
   * Config option passed through to `FilterPicker` - if not used, `FilterPicker` is not displayed.
   */
  filters: (prop_types__WEBPACK_IMPORTED_MODULE_11___default().array),

  /**
   * The `path` parameter supplied by React-Router
   */
  path: (prop_types__WEBPACK_IMPORTED_MODULE_11___default().string.isRequired),
   ...
   */
  showDatePicker: (prop_types__WEBPACK_IMPORTED_MODULE_11___default().bool),

  /**
   * The report where filter are placed.
   */
  report: (prop_types__WEBPACK_IMPORTED_MODULE_11___default().string.isRequired)
};
...
__webpack_require__.d(__webpack_exports__, {
  "default": function() { return /* binding */ customizable; }
});
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@wordpress+icons@8.1.0/node_modules/@wordpress/icons/build-module/library/plus-circle-filled.js
...
const plusCircleFilled = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@wordpress+icons@8.1.0/node_modules/@wordpress/icons/build-module/library/arrow-right.js
...
const arrowRight = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, (0,external_wp_element_.createElement)(external_wp_primitives_.Path, {
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@wordpress+icons@8.1.0/node_modules/@wordpress/icons/build-module/library/chart-bar.js
...
const chartBar = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, (0,external_wp_element_.createElement)(external_wp_primitives_.Path, {
  fillRule: "evenodd",
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/gridicons@3.4.0_react@17.0.2/node_modules/gridicons/dist/list-ordered.js
var list_ordered = __webpack_require__(36886);
...
const LazyDashboardCharts = (0,external_wp_element_.lazy)(() => Promise.all(/* import() | dashboard-charts */[__webpack_require__.e(5487), __webpack_require__.e(2397)]).then(__webpack_require__.bind(__webpack_require__, 2445)));
const LazyLeaderboards = (0,external_wp_element_.lazy)(() => __webpack_require__.e(/* import() | leaderboards */ 727).then(__webpack_require__.bind(__webpack_require__, 31082)));
const LazyStorePerformance = (0,external_wp_element_.lazy)(() => __webpack_require__.e(/* import() | store-performance */ 2624).then(__webpack_require__.bind(__webpack_require__, 83285)));

const DashboardCharts = props => (0,external_wp_element_.createElement)(external_wp_element_.Suspense, {
  fallback: (0,external_wp_element_.createElement)(external_wc_components_.Spinner, null)
}, (0,external_wp_element_.createElement)(LazyDashboardCharts, props));

const Leaderboards = props => (0,external_wp_element_.createElement)(external_wp_element_.Suspense, {
  fallback: (0,external_wp_element_.createElement)(external_wc_components_.Spinner, null)
}, (0,external_wp_element_.createElement)(LazyLeaderboards, props));

const StorePerformance = props => (0,external_wp_element_.createElement)(external_wp_element_.Suspense, {
  fallback: (0,external_wp_element_.createElement)(external_wc_components_.Spinner, null)
}, (0,external_wp_element_.createElement)(LazyStorePerformance, props));
...
/* harmony default export */ var default_sections = ((0,external_wp_hooks_.applyFilters)(DEFAULT_SECTIONS_FILTER, [{
  key: 'store-performance',
  component: StorePerformance,
  title: (0,external_wp_i18n_.__)('Performance', 'woocommerce'),
  isVisible: true,
  icon: arrow_right,
  ...
  title: (0,external_wp_i18n_.__)('Charts', 'woocommerce'),
  isVisible: true,
  icon: chart_bar,
  ...
  title: (0,external_wp_i18n_.__)('Leaderboards', 'woocommerce'),
  isVisible: true,
  icon: (0,external_wp_element_.createElement)(list_ordered/* default */.Z, null),
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@wordpress+icons@8.1.0/node_modules/@wordpress/icons/build-module/library/trash.js
...
const trash = (0,external_wp_element_.createElement)(external_wp_primitives_.SVG, {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24"
}, (0,external_wp_element_.createElement)(external_wp_primitives_.Path, {
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/gridicons@3.4.0_react@17.0.2/node_modules/gridicons/dist/chevron-up.js
var chevron_up = __webpack_require__(59449);
// EXTERNAL MODULE: ../../node_modules/.pnpm/gridicons@3.4.0_react@17.0.2/node_modules/gridicons/dist/chevron-down.js
var chevron_down = __webpack_require__(10918);
...
class SectionControls extends external_wp_element_.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (0,external_wp_element_.createElement)(external_wp_element_.Fragment, null, (0,external_wp_element_.createElement)("div", {
      ...
      label: (0,external_wp_i18n_.__)('Section title', 'woocommerce'),
      onBlur: onTitleBlur,
    ...
    }, !isFirst && (0,external_wp_element_.createElement)(external_wc_components_.MenuItem, {
      isClickable: true,
      onInvoke: this.onMoveUp
    }, (0,external_wp_element_.createElement)(icon/* default */.Z, {
      icon: (0,external_wp_element_.createElement)(chevron_up/* default */.Z, null),
      label: (0,external_wp_i18n_.__)('Move up'),
      size: 20,
      className: "icon-control"
    }), (0,external_wp_i18n_.__)('Move up', 'woocommerce')), !isLast && (0,external_wp_element_.createElement)(external_wc_components_.MenuItem, {
      isClickable: true,
      onInvoke: this.onMoveDown
    }, (0,external_wp_element_.createElement)(icon/* default */.Z, {
      icon: (0,external_wp_element_.createElement)(chevron_down/* default */.Z, null),
      size: 20,
      label: (0,external_wp_i18n_.__)('Move down'),
      className: "icon-control"
    }), (0,external_wp_i18n_.__)('Move down', 'woocommerce')), (0,external_wp_element_.createElement)(external_wc_components_.MenuItem, {
      isClickable: true,
      onInvoke: onRemove
    }, (0,external_wp_element_.createElement)(icon/* default */.Z, {
      icon: library_trash,
      size: 20,
      label: (0,external_wp_i18n_.__)('Remove block'),
      className: "icon-control"
    }), (0,external_wp_i18n_.__)('Remove section', 'woocommerce'))));
  }

}

/* harmony default export */ var section_controls = (SectionControls);
...
class Section extends external_wp_element_.Component {
  constructor(props) {
    super(props);
    const {
      title
  ...
  onToggleHiddenBlock(key) {
    return () => {
      const hiddenBlocks = (0,external_lodash_.xor)(this.props.hiddenBlocks, [key]);
  ...
  render() {
    ...
    }, (0,external_wp_element_.createElement)(SectionComponent, (0,esm_extends/* default */.Z)({
...
const filters = (0,external_wp_hooks_.applyFilters)(DASHBOARD_FILTERS_FILTER, []);
...
const CustomizableDashboard = _ref => {
  ...
  const sections = (0,external_wp_element_.useMemo)(() => mergeSectionsWithDefaults(userPrefs.dashboard_sections), [userPrefs.dashboard_sections]);
  ...
  const onSectionTitleUpdate = updatedKey => {
    return updatedTitle => {
      (0,external_wc_tracks_.recordEvent)('dash_section_rename', {
        key: updatedKey
      });
      updateSection(updatedKey, {
        title: updatedTitle
  ...
  const toggleVisibility = (key, onToggle) => {
    return () => {
      ...
      if (toggledSection.isVisible) {
        (0,external_wc_tracks_.recordEvent)('dash_section_add', {
          key: toggledSection.key
        });
      } else {
        (0,external_wc_tracks_.recordEvent)('dash_section_remove', {
          key: toggledSection.key
        });
      }
  ...
  const onMove = (index, change) => {
    ...
    index === sections.length - 1 // Will this be the last element?
      ...
      (0,external_wc_tracks_.recordEvent)('dash_section_order_change', eventProps);
    } else {
  ...
  const renderAddMore = () => {
    ...
    return (0,external_wp_element_.createElement)(external_wp_components_.Dropdown, {
      position: "top center",
      ...
      renderToggle: _ref2 => {
        ...
        return (0,external_wp_element_.createElement)(external_wp_components_.Button, {
          onClick: onToggle,
          title: (0,external_wp_i18n_.__)('Add more sections', 'woocommerce'),
      ...
      renderContent: _ref3 => {
        ...
        return (0,external_wp_element_.createElement)(external_wp_element_.Fragment, null, (0,external_wp_element_.createElement)(external_wc_components_.H, null, (0,external_wp_i18n_.__)('Dashboard Sections', 'woocommerce')), (0,external_wp_element_.createElement)("div", {
          ...
          return (0,external_wp_element_.createElement)(external_wp_components_.Button, {
            ...
            title: (0,external_wp_i18n_.sprintf)((0,external_wp_i18n_.__)('Add %s section', 'woocommerce'), section.title)
          }, (0,external_wp_element_.createElement)(icon/* default */.Z, {
  ...
  const renderDashboardReports = () => {
    const {
      ...
      before,
      after
    } = (0,external_wc_date_.getDateParamsFromQuery)(query, defaultDateRange);
    const {
      primary: primaryDate,
      secondary: secondaryDate
    ...
    return (0,external_wp_element_.createElement)(external_wp_element_.Fragment, null, (0,external_wp_element_.createElement)(report_filters/* default */.Z, {
      ...
      if (section.isVisible) {
        return (0,external_wp_element_.createElement)(Section, {
          ...
          query: query,
          title: section.title,
          onMove: (0,external_lodash_.partial)(onMove, index),
  ...
  return (0,external_wp_element_.createElement)(currency_context/* CurrencyContext.Provider */.$.Provider, {
    value: (0,currency_context/* getFilteredCurrencyInstance */.s)((0,external_wc_navigation_.getQuery)())
  }, renderDashboardReports());
};

/* harmony default export */ var customizable = ((0,external_wp_compose_.compose)((0,external_wp_data_.withSelect)(select => {
  const {
    woocommerce_default_date_range: defaultDateRange
