...
__webpack_require__.d(__webpack_exports__, {
  "WooNavigationItem": function() { return /* binding */ WooNavigationItem; },
  "addHistoryListener": function() { return /* binding */ addHistoryListener; },
  "flattenFilters": function() { return /* reexport */ flattenFilters; },
  "getActiveFiltersFromQuery": function() { return /* reexport */ getActiveFiltersFromQuery; },
  "getDefaultOptionValue": function() { return /* reexport */ getDefaultOptionValue; },
  "getHistory": function() { return /* reexport */ getHistory; },
  "getIdsFromQuery": function() { return /* binding */ getIdsFromQuery; },
  "getNewPath": function() { return /* binding */ getNewPath; },
  "getPath": function() { return /* binding */ getPath; },
  "getPersistedQuery": function() { return /* binding */ getPersistedQuery; },
  "getQuery": function() { return /* binding */ getQuery; },
  "getQueryExcludedScreens": function() { return /* binding */ getQueryExcludedScreens; },
  "getQueryFromActiveFilters": function() { return /* reexport */ getQueryFromActiveFilters; },
  "getScreenFromPath": function() { return /* binding */ getScreenFromPath; },
  "getSearchWords": function() { return /* binding */ getSearchWords; },
  "getSetOfIdsFromQuery": function() { return /* binding */ getSetOfIdsFromQuery; },
  "getUrlKey": function() { return /* reexport */ getUrlKey; },
  "onQueryChange": function() { return /* binding */ onQueryChange; },
  "pathIsExcluded": function() { return /* binding */ pathIsExcluded; },
  "updateQueryString": function() { return /* binding */ updateQueryString; }
});
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/tiny-invariant@1.2.0/node_modules/tiny-invariant/dist/tiny-invariant.esm.js
...
;// CONCATENATED MODULE: ../../packages/js/navigation/build-module/history.js
/**
...
;// CONCATENATED MODULE: ../../packages/js/navigation/build-module/filters.js
/**
 * External dependencies
 */
...
function flattenFilters(filters) {
  ...
  filters.forEach(f => {
    if (!f.subFilters) {
      ...
      allFilters.push((0,external_lodash_namespaceObject.omit)(f, 'subFilters'));
...
function getDefaultOptionValue(config, options) {
  ...
  if (config.input.defaultOption) {
    const option = (0,external_lodash_namespaceObject.find)(options, {
      value: defaultOption
    });
  ...
  return (0,external_lodash_namespaceObject.get)(options, [0, 'value']);
}
/**
...
;// CONCATENATED MODULE: ../../packages/js/navigation/build-module/index.js
/**
 * External dependencies
 */
...
const getPersistedQuery = function () {
   ...
   */
  const params = (0,external_wp_hooks_namespaceObject.applyFilters)('woocommerce_admin_persisted_queries', ['period', 'compare', 'before', 'after', 'interval', 'type']);
  return (0,external_lodash_namespaceObject.pick)(query, params);
};
/**
...
const getQueryExcludedScreens = () => (0,external_wp_hooks_namespaceObject.applyFilters)(TIME_EXCLUDED_SCREENS_FILTER, ['stock', 'settings', 'customers', 'homescreen']);
/**
...
function getNewPath(query) {
  ...
  return (0,external_wp_url_namespaceObject.addQueryArgs)('admin.php', args);
}
/**
...
(window.wc = window.wc || {}).navigation = __webpack_exports__;
/******/ })()
;