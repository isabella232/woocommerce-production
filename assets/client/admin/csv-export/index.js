...
__webpack_require__.d(__webpack_exports__, {
  "downloadCSVFile": function() { return /* binding */ downloadCSVFile; },
  "generateCSVDataFromTable": function() { return /* binding */ generateCSVDataFromTable; },
  "generateCSVFileName": function() { return /* binding */ generateCSVFileName; }
});

;// CONCATENATED MODULE: external "moment"
var external_moment_namespaceObject = window["moment"];
var external_moment_default = /*#__PURE__*/__webpack_require__.n(external_moment_namespaceObject);
// EXTERNAL MODULE: ../../node_modules/.pnpm/browser-filesaver@1.1.1/node_modules/browser-filesaver/FileSaver.js
var FileSaver = __webpack_require__(92868);
;// CONCATENATED MODULE: ../../packages/js/csv-export/build-module/index.js
/**
...
function generateCSVFileName() {
  ...
  const fileNameSections = [name.toLowerCase().replace(/[^a-z0-9]/g, '-'), external_moment_default()().format('YYYY-MM-DD'), Object.keys(params).map(key => key.toLowerCase().replace(/[^a-z0-9]/g, '-') + '-' + decodeURIComponent(params[key]).toLowerCase().replace(/[^a-z0-9]/g, '-')).join('_')].filter(text => text.length);
...
function downloadCSVFile(fileName, content) {
  ...
  (0,FileSaver.saveAs)(blob, fileName);
}
}();
(window.wc = window.wc || {}).csvExport = __webpack_exports__;
/******/ })()
;