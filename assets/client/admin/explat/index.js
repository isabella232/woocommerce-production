 ...
 */
__webpack_require__(52458);var f=__webpack_require__(99196),g=60103;exports.Fragment=60107;if("function"===typeof Symbol&&Symbol.for){var h=Symbol.for;g=h("react.element");exports.Fragment=h("react.fragment")}var m=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,n=Object.prototype.hasOwnProperty,p={key:!0,ref:!0,__self:!0,__source:!0};
...
if (true) {
  module.exports = __webpack_require__(95472);
} else {}
...
__webpack_require__.d(__webpack_exports__, {
  "Experiment": function() { return /* binding */ Experiment; },
  "ExperimentWithAuth": function() { return /* binding */ ExperimentWithAuth; },
  "ProvideExperimentData": function() { return /* binding */ ProvideExperimentData; },
  "ProvideExperimentDataWithAuth": function() { return /* binding */ ProvideExperimentDataWithAuth; },
  "dangerouslyGetExperimentAssignment": function() { return /* binding */ dangerouslyGetExperimentAssignment; },
  "dangerouslyGetExperimentAssignmentWithAuth": function() { return /* binding */ dangerouslyGetExperimentAssignmentWithAuth; },
  "initializeExPlat": function() { return /* binding */ initializeExPlat; },
  "loadExperimentAssignment": function() { return /* binding */ loadExperimentAssignment; },
  "loadExperimentAssignmentWithAuth": function() { return /* binding */ loadExperimentAssignmentWithAuth; },
  "useExperiment": function() { return /* binding */ useExperiment; },
  "useExperimentWithAuth": function() { return /* binding */ useExperimentWithAuth; }
});

;// CONCATENATED MODULE: ../../node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/internal/timing.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/internal/experiment-assignments.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/internal/local-storage.js
/**
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/internal/validations.js
function isObject(x) {
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/internal/experiment-assignment-store.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/internal/requests.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/create-explat-client.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@automattic+explat-client@0.0.3/node_modules/@automattic/explat-client/dist/esm/index.js
...
var jsx_runtime = __webpack_require__(61250);
// EXTERNAL MODULE: external "React"
var external_React_ = __webpack_require__(99196);
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@automattic+explat-client-react-helpers@0.0.4/node_modules/@automattic/explat-client-react-helpers/dist/esm/index.js
...
function createExPlatClientReactHelpers(exPlatClient) {
  const useExperiment = function (experimentName) {
    ...
    const [previousExperimentName] = (0,external_React_.useState)(experimentName);
    const [state, setState] = (0,external_React_.useState)([true, null]);
...
;// CONCATENATED MODULE: ../../packages/js/explat/build-module/utils.js
/**
 * Boolean determining if environment is development.
 */
const isDevelopmentMode = "production" === 'development';
;// CONCATENATED MODULE: ../../packages/js/explat/build-module/error.js
/**
...
;// CONCATENATED MODULE: ../../packages/js/explat/build-module/assignment.js
/**
...
const getRequestQueryString = _ref => {
  let {
    experimentName,
    anonId
  } = _ref;
  ...
  return (0,lib.stringify)((0,external_wp_hooks_namespaceObject.applyFilters)('woocommerce_explat_request_args', {
    experiment_name: experimentName,
    anon_id: anonId !== null && anonId !== void 0 ? anonId : undefined,
    woo_country_code: ((_c = (_b = (_a = window.wcSettings) === null || _a === void 0 ? void 0 : _a.preloadSettings) === null || _b === void 0 ? void 0 : _b.general) === null || _c === void 0 ? void 0 : _c.woocommerce_default_country) || ((_g = (_f = (_e = (_d = window.wcSettings) === null || _d === void 0 ? void 0 : _d.admin) === null || _e === void 0 ? void 0 : _e.preloadSettings) === null || _f === void 0 ? void 0 : _f.general) === null || _g === void 0 ? void 0 : _g.woocommerce_default_country)
  }));
};

const assignment_fetchExperimentAssignment = async _ref2 => {
  let {
    experimentName,
    anonId
  } = _ref2;
  ...
  return await window.fetch(`https://public-api.wordpress.com/wpcom/v2/experiments/${EXPLAT_VERSION}/assignments/woocommerce?${getRequestQueryString({
    experimentName,
    anonId
  })}`);
};
const fetchExperimentAssignmentWithAuth = async _ref3 => {
  let {
    experimentName,
    anonId
  } = _ref3;
...
;// CONCATENATED MODULE: ../../packages/js/explat/build-module/anon.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ../../packages/js/explat/build-module/index.js
/**
 * External dependencies
 */
...
initializeExPlat();
const exPlatClient = esm_createExPlatClient({
...
const {
  ...
  Experiment,
  ProvideExperimentData
} = createExPlatClientReactHelpers(exPlatClient); // Create another auth client that send request to wpcom as auth user.

const exPlatClientWithAuth = esm_createExPlatClient({
...
(window.wc = window.wc || {}).explat = __webpack_exports__;
/******/ })()
;