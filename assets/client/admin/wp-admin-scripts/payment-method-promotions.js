...
const PaymentPromotionRow = _ref => {
  ...
  const [installing, setInstalling] = (0,external_wp_element_namespaceObject.useState)(false);
  const [isVisible, setIsVisible] = (0,external_wp_element_namespaceObject.useState)(true);
  const {
    installAndActivatePlugins
  } = (0,external_wp_data_namespaceObject.useDispatch)(external_wc_data_namespaceObject.PLUGINS_STORE_NAME);
  const {
    createNotice
  } = (0,external_wp_data_namespaceObject.useDispatch)('core/notices');
  const {
    updatePaymentGateway
  } = (0,external_wp_data_namespaceObject.useDispatch)(external_wc_data_namespaceObject.PAYMENT_GATEWAYS_STORE_NAME);
  const {
    gatewayIsActive,
    paymentGateway
    ...
    const {
      getPaymentGateway
    } = select(external_wc_data_namespaceObject.PAYMENT_GATEWAYS_STORE_NAME);
    const activePlugins = select(external_wc_data_namespaceObject.PLUGINS_STORE_NAME).getActivePlugins();
  ...
  const installPaymentGateway = () => {
    ...
    setInstalling(true);
    (0,external_wc_tracks_namespaceObject.recordEvent)('settings_payments_recommendations_setup', {
  ...
  const onDismiss = () => {
    setIsVisible(false);
    (0,external_wc_tracks_namespaceObject.recordEvent)('settings_payments_promotions_dismiss', {
      id: gatewayId
    });
  ...
  return (0,external_wp_element_namespaceObject.createElement)(external_wp_element_namespaceObject.Fragment, null, columns.map(column => {
    if (column.className.includes('name')) {
      return (0,external_wp_element_namespaceObject.createElement)("td", {
        className: "name",
        key: column.className
      }, (0,external_wp_element_namespaceObject.createElement)("div", {
        className: "wc-payment-gateway-method__name"
      }, (0,external_wp_element_namespaceObject.createElement)(external_wc_components_namespaceObject.Link, {
        target: "_blank",
        type: "external",
        rel: "noreferrer",
        href: url
      }, title), subTitleContent ? (0,external_wp_element_namespaceObject.createElement)("div", {
      ...
      }, (0,external_wp_element_namespaceObject.createElement)(external_wc_components_namespaceObject.EllipsisMenu, {
        label: (0,external_wp_i18n_namespaceObject.__)('Payment Promotion Options', 'woocommerce'),
      ...
      }, (0,external_wp_i18n_namespaceObject.__)('Install', 'woocommerce'))));
    }
...
PAYMENT_METHOD_PROMOTIONS.forEach(paymentMethod => {
  ...
  if (container) {
    ...
    (0,external_wp_element_namespaceObject.render)((0,external_wp_element_namespaceObject.createElement)(PaymentPromotionRow, {
      columns: columns,
...
(window.wc = window.wc || {}).paymentMethodPromotions = __webpack_exports__;
/******/ })()
;