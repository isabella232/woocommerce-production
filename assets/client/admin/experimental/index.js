...
(function webpackUniversalModuleDefinition(root, factory) {
	if(true)
		module.exports = factory(__webpack_require__(99196), __webpack_require__(91850));
	else {}
...
__webpack_require__.d(__webpack_exports__, {
  "CollapsibleList": function() { return /* reexport */ ExperimentalCollapsibleList; },
  "InboxDismissConfirmationModal": function() { return /* reexport */ InboxDismissConfirmationModal; },
  "InboxNoteCard": function() { return /* reexport */ InboxNoteCard; },
  "InboxNotePlaceholder": function() { return /* reexport */ InboxNotePlaceholder; },
  "List": function() { return /* reexport */ ExperimentalList; },
  "ListItem": function() { return /* reexport */ ExperimentalListItem; },
  "Navigation": function() { return /* binding */ Navigation; },
  "NavigationBackButton": function() { return /* binding */ NavigationBackButton; },
  "NavigationGroup": function() { return /* binding */ NavigationGroup; },
  "NavigationItem": function() { return /* binding */ NavigationItem; },
  "NavigationMenu": function() { return /* binding */ NavigationMenu; },
  "TaskItem": function() { return /* reexport */ TaskItem; },
  "Text": function() { return /* binding */ Text; },
  "VerticalCSSTransition": function() { return /* reexport */ VerticalCSSTransition; },
  "useSlot": function() { return /* binding */ useSlot; }
});
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/react-transition-group@4.4.2/node_modules/react-transition-group/esm/config.js
/* harmony default export */ var config = ({
  disabled: false
});
;// CONCATENATED MODULE: ../../node_modules/.pnpm/react-transition-group@4.4.2/node_modules/react-transition-group/esm/TransitionGroupContext.js

/* harmony default export */ var TransitionGroupContext = (external_React_default().createContext(null));
;// CONCATENATED MODULE: ../../node_modules/.pnpm/react-transition-group@4.4.2/node_modules/react-transition-group/esm/Transition.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/react-transition-group@4.4.2/node_modules/react-transition-group/esm/CSSTransition.js
...
var CSSTransition = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return /*#__PURE__*/external_React_default().createElement(esm_Transition, _extends({}, props, {
...
;// CONCATENATED MODULE: ../../packages/js/experimental/build-module/experimental-list/experimental-list-item.js
/**
...
function handleKeyDown(event, onClick) {
  if (typeof onClick === 'function' && event.keyCode === external_wp_keycodes_namespaceObject.ENTER) {
    onClick(event);
  }
}
...
const ExperimentalListItem = _ref => {
  ...
  return (0,external_wp_element_namespaceObject.createElement)(esm_CSSTransition, {
    timeout: 500,
    ...
    enter: enter,
    onExited: onExited
  }, (0,external_wp_element_namespaceObject.createElement)("li", { ...roleProps,
    ...otherProps,
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/react-transition-group@4.4.2/node_modules/react-transition-group/esm/utils/ChildMapping.js
...
;// CONCATENATED MODULE: ../../node_modules/.pnpm/react-transition-group@4.4.2/node_modules/react-transition-group/esm/TransitionGroup.js
...
;// CONCATENATED MODULE: ../../packages/js/experimental/build-module/experimental-list/experimental-list.js
/**
 * External dependencies
 */
...
const ExperimentalList = _ref => {
  ...
  return (0,external_wp_element_namespaceObject.createElement)(esm_TransitionGroup, {
    component: listType || 'ul',
    className: "woocommerce-experimental-list",
    ...otherProps
  }, external_wp_element_namespaceObject.Children.map(children, child => {
    if ((0,external_wp_element_namespaceObject.isValidElement)(child)) {
      const {
        onExited,
        in: inTransition,
        enter,
      ...
      }, (0,external_wp_element_namespaceObject.cloneElement)(child, {
...
;// CONCATENATED MODULE: ../../packages/js/experimental/build-module/experimental-list/collapsible-list/index.js
/**
 * External dependencies
 */
...
const ExperimentalCollapsibleList = _ref => {
  ...
  const [isCollapsed, setCollapsed] = (0,external_wp_element_namespaceObject.useState)(collapsed);
  const [isTransitionComponentCollapsed, setTransitionComponentCollapsed] = (0,external_wp_element_namespaceObject.useState)(collapsed);
  const [footerLabels, setFooterLabels] = (0,external_wp_element_namespaceObject.useState)({
    collapse: collapseLabel,
    expand: expandLabel
  });
  const [displayedChildren, setDisplayedChildren] = (0,external_wp_element_namespaceObject.useState)({
    all: [],
    shown: [],
    hidden: []
  });
  const collapseContainerRef = (0,external_wp_element_namespaceObject.useRef)(null);

  const updateChildren = () => {
    let shownChildren = [];
    const allChildren = external_wp_element_namespaceObject.Children.map(children, child => (0,external_wp_element_namespaceObject.isValidElement)(child) && 'key' in child ? child : null) || [];
  ...
  const clickHandler = (0,external_wp_element_namespaceObject.useCallback)(() => {
  ...
  return (0,external_wp_element_namespaceObject.createElement)(ExperimentalList, { ...listProps,
    className: listClasses
  }, [...displayedChildren.shown, (0,external_wp_element_namespaceObject.createElement)(esm_Transition, {
    ...
    }, (0,external_wp_element_namespaceObject.createElement)(esm_TransitionGroup, {
      className: "woocommerce-experimental-list"
    }, external_wp_element_namespaceObject.Children.map(displayedChildren.hidden, child => {
      const {
        onExited,
        in: inTransition,
        enter,
  ...
  }), displayedChildren.hidden.length > 0 ? (0,external_wp_element_namespaceObject.createElement)(ExperimentalListItem, {
    key: "collapse-item",
    className: "list-item-collapse",
    onClick: clickHandler,
    animation: "none",
    disableGutters: true
  }, (0,external_wp_element_namespaceObject.createElement)("p", null, isCollapsed ? footerLabels.expand : footerLabels.collapse), (0,external_wp_element_namespaceObject.createElement)(icon, {
    className: "list-item-collapse__icon",
    size: 30,
    icon: isCollapsed ? chevron_down : chevron_up
  })) : null]);
};
;// CONCATENATED MODULE: external ["wp","i18n"]
var external_wp_i18n_namespaceObject = window["wp"]["i18n"];
;// CONCATENATED MODULE: ../../node_modules/.pnpm/@wordpress+icons@8.1.0/node_modules/@wordpress/icons/build-module/library/check.js
...
// EXTERNAL MODULE: ../../node_modules/.pnpm/gridicons@3.4.0/node_modules/gridicons/dist/notice-outline.js
var notice_outline = __webpack_require__(77672);
...
;// CONCATENATED MODULE: ../../packages/js/experimental/build-module/vertical-css-transition/vertical-css-transition.js
/**
 * External dependencies
 */
...
const VerticalCSSTransition = _ref => {
  ...
  const [containerHeight, setContainerHeight] = (0,external_wp_element_namespaceObject.useState)(0);
  const [transitionIn, setTransitionIn] = (0,external_wp_element_namespaceObject.useState)(props.in || false);
  const cssTransitionRef = (0,external_wp_element_namespaceObject.useRef)(null);
  const collapseContainerRef = (0,external_wp_element_namespaceObject.useCallback)(containerElement => {
    if (containerElement) {
  ...
  return (0,external_wp_element_namespaceObject.createElement)(esm_CSSTransition, { ...props,
    in: transitionIn,
    ref: cssTransitionRef
  }, state => (0,external_wp_element_namespaceObject.createElement)("div", {
    className: "vertical-css-transition-container",
    style: getTransitionStyle(state),
    ref: collapseContainerRef
  }, children));
};
;// CONCATENATED MODULE: ../../packages/js/experimental/build-module/experimental-list/task-item/index.js
/**
 * External dependencies
 */
...
const OptionalTaskTooltip = _ref => {
  ...
  if (level === 1 && !completed) {
    tooltip = (0,external_wp_i18n_namespaceObject.__)('This task is required to keep your store running', 'woocommerce');
  } else if (level === 2 && !completed) {
    tooltip = (0,external_wp_i18n_namespaceObject.__)('This task is required to set up your extension', 'woocommerce');
  }
...
const OptionalExpansionWrapper = _ref2 => {
  ...
  if (!expandable) {
    return expanded ? (0,external_wp_element_namespaceObject.createElement)(external_wp_element_namespaceObject.Fragment, null, children) : null;
  }

  return (0,external_wp_element_namespaceObject.createElement)(VerticalCSSTransition, {
    timeout: 500,
    in: expanded,
...
const TaskItem = _ref3 => {
  ...
  const [isTaskExpanded, setTaskExpanded] = (0,external_wp_element_namespaceObject.useState)(expanded);
  (0,external_wp_element_namespaceObject.useEffect)(() => {
  ...
  return (0,external_wp_element_namespaceObject.createElement)(ExperimentalListItem, {
    disableGutters: true,
    className: className,
    onClick: expandable && showActionButton ? toggleActionVisibility : onClick,
    ...listItemProps
  }, (0,external_wp_element_namespaceObject.createElement)(OptionalTaskTooltip, {
    level: level,
    completed: completed
  }, (0,external_wp_element_namespaceObject.createElement)("div", {
    className: "woocommerce-task-list__item-before"
  }, level === 1 && !completed ? (0,external_wp_element_namespaceObject.createElement)(notice_outline/* default */.Z, {
    size: 36
  }) : (0,external_wp_element_namespaceObject.createElement)("div", {
    className: "woocommerce-task__icon"
  }, completed && (0,external_wp_element_namespaceObject.createElement)(icon, {
    icon: library_check
  })))), (0,external_wp_element_namespaceObject.createElement)("div", {
    className: "woocommerce-task-list__item-text"
  }, (0,external_wp_element_namespaceObject.createElement)(Text, {
    as: "div",
    size: "14",
  ...
  }, title), (0,external_wp_element_namespaceObject.createElement)(OptionalExpansionWrapper, {
    expandable: expandable,
    expanded: isTaskExpanded
  }, (0,external_wp_element_namespaceObject.createElement)("div", {
    className: "woocommerce-task-list__item-expandable-content"
  }, content, expandable && !completed && additionalInfo && (0,external_wp_element_namespaceObject.createElement)("div", {
    className: "woocommerce-task__additional-info",
    dangerouslySetInnerHTML: sanitizeHTML(additionalInfo)
  }), !completed && showActionButton && (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.Button, {
  ...
  }, actionLabel || title))), !expandable && !completed && additionalInfo && (0,external_wp_element_namespaceObject.createElement)("div", {
    className: "woocommerce-task__additional-info",
    dangerouslySetInnerHTML: sanitizeHTML(additionalInfo)
  }), time && (0,external_wp_element_namespaceObject.createElement)("div", {
    className: "woocommerce-task__estimated-time"
  }, time))), showEllipsisMenu && (0,external_wp_element_namespaceObject.createElement)(external_wc_components_namespaceObject.EllipsisMenu, {
    label: (0,external_wp_i18n_namespaceObject.__)('Task Options', 'woocommerce'),
    ...
    }, onDismiss && !completed && (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.Button, {
      onClick: e => {
        e.stopPropagation();
        onDismiss();
      }
    }, (0,external_wp_i18n_namespaceObject.__)('Dismiss', 'woocommerce')), onSnooze && !completed && (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.Button, {
      onClick: e => {
        e.stopPropagation();
        onSnooze();
      }
    }, (0,external_wp_i18n_namespaceObject.__)('Remind me later', 'woocommerce')), onDelete && completed && (0,external_wp_element_namespaceObject.createElement)(external_wp_components_namespaceObject.Button, {
      onClick: e => {
        e.stopPropagation();
        onDelete();
      }
    }, (0,external_wp_i18n_namespaceObject.__)('Delete', 'woocommerce')))
  }));
};
// EXTERNAL MODULE: ../../node_modules/.pnpm/react-visibility-sensor@5.1.1/node_modules/react-visibility-sensor/dist/visibility-sensor.js
var visibility_sensor = __webpack_require__(65193);
...
;// CONCATENATED MODULE: ../../packages/js/experimental/build-module/inbox-note/action.js
/**
 * External dependencies
 */
...
const InboxNoteActionButton = _ref => {
  ...
  const [inAction, setInAction] = (0,external_wp_element_namespaceObject.useState)(false);
...
;// CONCATENATED MODULE: ../../packages/js/experimental/build-module/inbox-note/use-callback-on-link-click.js
/**
 * External dependencies
 */

function useCallbackOnLinkClick(onClick) {
  const onNodeClick = (0,external_wp_element_namespaceObject.useCallback)(event => {
...
;// CONCATENATED MODULE: ../../packages/js/experimental/build-module/inbox-note/inbox-note.js
/**
 * External dependencies
 */
...
const InboxNoteCard = _ref => {
  ...
  const [clickedActionText, setClickedActionText] = (0,external_wp_element_namespaceObject.useState)(false);
  const hasBeenSeen = (0,external_wp_element_namespaceObject.useRef)(false);
  ...
  const renderDismissButton = () => {
    ...
    }, (0,external_wp_i18n_namespaceObject.__)('Dismiss', 'woocommerce'));
  };
  ...
  const renderActions = () => {
    ...
    return (0,external_wp_element_namespaceObject.createElement)(external_wp_element_namespaceObject.Fragment, null, noteActions.map(action => (0,external_wp_element_namespaceObject.createElement)(InboxNoteActionButton, {
      key: action.id,
      label: action.label,
      variant: "secondary",
  ...
  return (0,external_wp_element_namespaceObject.createElement)((visibility_sensor_default()), {
    onChange: onVisible
  }, (0,external_wp_element_namespaceObject.createElement)("section", {
    className: cardClassName
  }, hasImage && (0,external_wp_element_namespaceObject.createElement)("div", {
  ...
  }, unread && (0,external_wp_element_namespaceObject.createElement)("div", {
    className: "woocommerce-inbox-message__unread-indicator"
  }), dateCreatedGmt && (0,external_wp_element_namespaceObject.createElement)("span", {
    className: "woocommerce-inbox-message__date"
  }, external_moment_default().utc(dateCreatedGmt).fromNow()), (0,external_wp_element_namespaceObject.createElement)(external_wc_components_namespaceObject.H, {
    className: "woocommerce-inbox-message__title"
  }, note.actions && note.actions.length === 1 && (0,external_wp_element_namespaceObject.createElement)(InboxNoteActionButton, {
  ...
  }), note.actions && note.actions.length > 1 && title), (0,external_wp_element_namespaceObject.createElement)(external_wc_components_namespaceObject.Section, {
...
;// CONCATENATED MODULE: ../../packages/js/experimental/build-module/inbox-note/inbox-dismiss-confirmation-modal.js
/**
 * External dependencies
 */
...
const InboxDismissConfirmationModal = _ref => {
  let {
    onClose,
    onDismiss,
    buttonLabel = (0,external_wp_i18n_namespaceObject.__)("Yes, I'm sure", 'woocommerce')
  } = _ref;
  const [inAction, setInAction] = (0,external_wp_element_namespaceObject.useState)(false);
  ...
  }, (0,external_wp_element_namespaceObject.createElement)("p", null, (0,external_wp_i18n_namespaceObject.__)('Dismissed messages cannot be viewed again', 'woocommerce')), (0,external_wp_element_namespaceObject.createElement)("div", {
...
;// CONCATENATED MODULE: ../../packages/js/experimental/build-module/inbox-note/placeholder.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ../../packages/js/experimental/build-module/inbox-note/index.js



;// CONCATENATED MODULE: ../../packages/js/experimental/build-module/vertical-css-transition/index.js

;// CONCATENATED MODULE: ../../packages/js/experimental/build-module/index.js
/**
 * External dependencies
 */
...
const Navigation = external_wp_components_namespaceObject.Navigation || external_wp_components_namespaceObject.__experimentalNavigation;
const NavigationBackButton = external_wp_components_namespaceObject.NavigationBackButton || external_wp_components_namespaceObject.__experimentalNavigationBackButton;
const NavigationGroup = external_wp_components_namespaceObject.NavigationGroup || external_wp_components_namespaceObject.__experimentalNavigationGroup;
const NavigationMenu = external_wp_components_namespaceObject.NavigationMenu || external_wp_components_namespaceObject.__experimentalNavigationMenu;
const NavigationItem = external_wp_components_namespaceObject.NavigationItem || external_wp_components_namespaceObject.__experimentalNavigationItem;
const Text = external_wp_components_namespaceObject.Text || external_wp_components_namespaceObject.__experimentalText;
const useSlot = external_wp_components_namespaceObject.useSlot || external_wp_components_namespaceObject.__experimentalUseSlot;
...
(window.wc = window.wc || {}).experimental = __webpack_exports__;
/******/ })()
;