...
__webpack_require__.d(__webpack_exports__, {
  "appendTimestamp": function() { return /* binding */ appendTimestamp; },
  "dateValidationMessages": function() { return /* binding */ dateValidationMessages; },
  "dayTicksThreshold": function() { return /* binding */ dayTicksThreshold; },
  "defaultDateTimeFormat": function() { return /* binding */ defaultDateTimeFormat; },
  "defaultTableDateFormat": function() { return /* binding */ defaultTableDateFormat; },
  "getAllowedIntervalsForQuery": function() { return /* binding */ getAllowedIntervalsForQuery; },
  "getChartTypeForQuery": function() { return /* binding */ getChartTypeForQuery; },
  "getCurrentDates": function() { return /* binding */ getCurrentDates; },
  "getCurrentPeriod": function() { return /* binding */ getCurrentPeriod; },
  "getDateDifferenceInDays": function() { return /* binding */ getDateDifferenceInDays; },
  "getDateFormatsForInterval": function() { return /* binding */ getDateFormatsForInterval; },
  "getDateFormatsForIntervalD3": function() { return /* binding */ getDateFormatsForIntervalD3; },
  "getDateFormatsForIntervalPhp": function() { return /* binding */ getDateFormatsForIntervalPhp; },
  "getDateParamsFromQuery": function() { return /* binding */ getDateParamsFromQuery; },
  "getIntervalForQuery": function() { return /* binding */ getIntervalForQuery; },
  "getLastPeriod": function() { return /* binding */ getLastPeriod; },
  "getPreviousDate": function() { return /* binding */ getPreviousDate; },
  "getRangeLabel": function() { return /* binding */ getRangeLabel; },
  "getStoreTimeZoneMoment": function() { return /* binding */ getStoreTimeZoneMoment; },
  "isoDateFormat": function() { return /* binding */ isoDateFormat; },
  "loadLocaleData": function() { return /* binding */ loadLocaleData; },
  "periods": function() { return /* binding */ periods; },
  "presetValues": function() { return /* binding */ presetValues; },
  "toMoment": function() { return /* binding */ toMoment; },
  "validateDateInputForRange": function() { return /* binding */ validateDateInputForRange; },
  "weekTicksThreshold": function() { return /* binding */ weekTicksThreshold; }
});
...
;// CONCATENATED MODULE: ../../packages/js/date/build-module/index.js
/**
...
const presetValues = [{
  value: 'today',
  label: (0,external_wp_i18n_namespaceObject.__)('Today', 'woocommerce')
}, {
  value: 'yesterday',
  label: (0,external_wp_i18n_namespaceObject.__)('Yesterday', 'woocommerce')
}, {
  value: 'week',
  label: (0,external_wp_i18n_namespaceObject.__)('Week to date', 'woocommerce')
}, {
  value: 'last_week',
  label: (0,external_wp_i18n_namespaceObject.__)('Last week', 'woocommerce')
}, {
  value: 'month',
  label: (0,external_wp_i18n_namespaceObject.__)('Month to date', 'woocommerce')
}, {
  value: 'last_month',
  label: (0,external_wp_i18n_namespaceObject.__)('Last month', 'woocommerce')
}, {
  value: 'quarter',
  label: (0,external_wp_i18n_namespaceObject.__)('Quarter to date', 'woocommerce')
}, {
  value: 'last_quarter',
  label: (0,external_wp_i18n_namespaceObject.__)('Last quarter', 'woocommerce')
}, {
  value: 'year',
  label: (0,external_wp_i18n_namespaceObject.__)('Year to date', 'woocommerce')
}, {
  value: 'last_year',
  label: (0,external_wp_i18n_namespaceObject.__)('Last year', 'woocommerce')
}, {
  value: 'custom',
  label: (0,external_wp_i18n_namespaceObject.__)('Custom', 'woocommerce')
}];
const periods = [{
  value: 'previous_period',
  label: (0,external_wp_i18n_namespaceObject.__)('Previous period', 'woocommerce')
}, {
  value: 'previous_year',
  label: (0,external_wp_i18n_namespaceObject.__)('Previous year', 'woocommerce')
}];
/**
...
function toMoment(format, str) {
  if (external_moment_default().isMoment(str)) {
    return str.isValid() ? str : null;
  }

  if (typeof str === 'string') {
    const date = external_moment_default()(str, [isoDateFormat, format], true);
...
function getRangeLabel(after, before) {
  ...
  const fullDateFormat = (0,external_wp_i18n_namespaceObject.__)('MMM D, YYYY', 'woocommerce');
  ...
  if (isSameDay) {
    ...
    const monthDayFormat = (0,external_wp_i18n_namespaceObject.__)('MMM D', 'woocommerce');
...
function getStoreTimeZoneMoment() {
  ...
  if (['+', '-'].includes(window.wcSettings.timeZone.charAt(0))) {
    return external_moment_default()().utcOffset(window.wcSettings.timeZone);
  }

  return external_moment_default()().tz(window.wcSettings.timeZone);
}
/**
...
function getLastPeriod(period, compare) {
  ...
  if (compare === 'previous_period') {
    if (period === 'year') {
      ...
      secondaryStart = external_moment_default()().startOf(period).subtract(2, period);
...
const getDateValue = (0,external_lodash_namespaceObject.memoize)((period, compare, after, before) => {
  switch (period) {
    case 'today':
...
const getDateParamsFromQueryMemoized = (0,external_lodash_namespaceObject.memoize)((period, compare, after, before, defaultDateRange) => {
  if (period && compare) {
    return {
      period,
      compare,
      after: after ? external_moment_default()(after) : null,
      before: before ? external_moment_default()(before) : null
    };
  }

  const queryDefaults = (0,lib.parse)(defaultDateRange.replace(/&amp;/g, '&'));
  return {
    period: queryDefaults.period,
    compare: queryDefaults.compare,
    after: queryDefaults.after ? external_moment_default()(queryDefaults.after) : null,
    before: queryDefaults.before ? external_moment_default()(queryDefaults.before) : null
  };
...
const getCurrentDatesMemoized = (0,external_lodash_namespaceObject.memoize)((period, compare, primaryStart, primaryEnd, secondaryStart, secondaryEnd) => ({
  primary: {
    label: (0,external_lodash_namespaceObject.find)(presetValues, item => item.value === period).label,
    range: getRangeLabel(primaryStart, primaryEnd),
    after: primaryStart,
    before: primaryEnd
  },
  secondary: {
    label: (0,external_lodash_namespaceObject.find)(periods, item => item.value === compare).label,
...
const getDateDifferenceInDays = (date, date2) => {
  const _date = external_moment_default()(date);

  const _date2 = external_moment_default()(date2);
...
const getPreviousDate = (date, date1, date2, compare, interval) => {
  const dateMoment = external_moment_default()(date);

  if (compare === 'previous_year') {
    return dateMoment.clone().subtract(1, 'years');
  }

  const _date1 = external_moment_default()(date1);
...
function getDateFormatsForIntervalD3(interval) {
  ...
  switch (interval) {
    ...
    case 'week':
      ...
      screenReaderFormat = (0,external_wp_i18n_namespaceObject.__)('Week of %B %-d, %Y', 'woocommerce'); // eslint-disable-next-line @wordpress/i18n-translator-comments

      tooltipLabelFormat = (0,external_wp_i18n_namespaceObject.__)('Week of %B %-d, %Y', 'woocommerce');
      break;
...
function getDateFormatsForIntervalPhp(interval) {
  ...
  switch (interval) {
    ...
    case 'week':
      ...
      const escapedWeekOfStr = (0,external_wp_i18n_namespaceObject.__)('Week of', 'woocommerce').replace(/(\w)/g, '\\$1');
...
function loadLocaleData(_ref2) {
  ...
  if (external_moment_default().locale() !== 'en') {
    external_moment_default().updateLocale(userLocale, {
      longDateFormat: {
        L: (0,external_wp_i18n_namespaceObject.__)('MM/DD/YYYY', 'woocommerce'),
        LL: (0,external_wp_i18n_namespaceObject.__)('MMMM D, YYYY', 'woocommerce'),
        LLL: (0,external_wp_i18n_namespaceObject.__)('D MMMM YYYY LT', 'woocommerce'),
        LLLL: (0,external_wp_i18n_namespaceObject.__)('dddd, D MMMM YYYY LT', 'woocommerce'),
        LT: (0,external_wp_i18n_namespaceObject.__)('HH:mm', 'woocommerce')
      },
...
const dateValidationMessages = {
  invalid: (0,external_wp_i18n_namespaceObject.__)('Invalid date', 'woocommerce'),
  future: (0,external_wp_i18n_namespaceObject.__)('Select a date in the past', 'woocommerce'),
  startAfterEnd: (0,external_wp_i18n_namespaceObject.__)('Start date must be before end date', 'woocommerce'),
  endBeforeStart: (0,external_wp_i18n_namespaceObject.__)('Start date must be before end date', 'woocommerce')
};
/**
...
function validateDateInputForRange(type, value, before, after, format) {
  ...
  if (external_moment_default()().isBefore(date, 'day')) {
    return {
      date: null,
...
(window.wc = window.wc || {}).date = __webpack_exports__;
/******/ })()
;